  ...
  return (
    <div className="max-w-full mx-auto p-4">
      <motion.div
        ...
        initial="hidden"
        animate="show"
        className="w-full max-w-[350px] mx-auto fixed bottom-0 left-1 right-1 bg-white py-1.5 px-3 flex justify-center items-center rounded-2xl shadow-lg ring-1 ring-slate-200"
      >
